                        ...
                        <?php 
                            ...
                            if(mysql_num_rows($re)> 0){
                                while($rows = mysql_fetch_array($re)){
                                    echo'
                                    <form role="form" id="formnew" action="updateprofile.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" class="form-control" name="adminID" id="adminID" placeholder="Room ID" value="' . $rows['adminID'] . '" required>
                                        <div class="form-group">
                                            <label for="username">Username</label>
                                            <input type="text" class="form-control" name="username" id="username" placeholder="Username" value="' . $rows['username'] . '" required>
                                        </div>
                                        <div class="form-group">
