                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" id="formnew" action="addcottage.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="room_name">Cottage Name</label>
                                    <input type="text" class="form-control" name="room_name" id="room_name" placeholder="Cottage Name" required>
                                </div>
                                <div class="form-group">
                                    <label for="total_room">Total Cottages</label>
                                    <input type="number" class="form-control" name="total_room" id="total_room" placeholder="Number of Cottage" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="rate" id="rate" placeholder="Rate of the cottage" required>
                                </div>
                                <div class="form-group">
                                    <label for="desc">Description</label>
                                    <input type="text" class="form-control" name="desc" id="desc" placeholder="Description for the cottage">
                                </div>
                                <div class="form-group">
                                    <label for="img">Upload Cottage Image [recommended size is 400 X 400]</label>
