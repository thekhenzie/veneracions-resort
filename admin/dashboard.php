						...
						<h4 class="sub-header">Search Booking</h4>
									<form class="form-inline" method="post" action="" >
									  <div class="form-group">
										...
										<input class="form-control awe-calendar from" name="checkin" id="checkin" placeholder="Start Date">
									  </div>
									  <div class="form-group">

										<input  class="form-control awe-calendar from" name="checkout" id="checkout" placeholder="End Date">
									  </div>
