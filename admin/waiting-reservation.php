...
<body class="hold-transition skin-yellow sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					Reservation > Waiting for user confirmation
				</h1>
			</section>
                                    ...
                                    while($row = mysql_fetch_array($re)){
                                        echo '
                                            <tr>
												...
												<td>
												<a href="adminaddpending.php?booking_id='.$row['booking_id'].'"class="btn btn-primary confirmbtn">Add to Pending</a>&nbsp;&nbsp; 
	...
	$('.confirmbtn').click (function () {
		return confirm ("Are you sure you want to add to pending?") ;
	});
    </script>
	<!-- REQUIRED JS SCRIPTS -->
	<!-- Bootstrap 3.3.7 -->
