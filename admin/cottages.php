                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="table-responsive">
                            <a href="add-cottage.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Cottage</a><br/><br/>
    ...
    while ($row = mysql_fetch_array($re)) {
        echo '
                                                    <tr>
                                                        ...
                                                        <td>' . $row['occupancy'] . '</td>
                                                        <td><a class="btn btn-primary" href="edit-cottage.php?room_id=' . $row['room_id'] . '">Edit</a></td>
                                                        <td><a class="btn btn-danger deletebtn" id="deletebtn" href="deletecottage.php?room_id=' . $row['room_id'] . '">Delete</a></td>
                                                    </tr>
                                                ';
    }
}
