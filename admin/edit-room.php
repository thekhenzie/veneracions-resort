                        ...
                        <div class="panel-body">
                            ...
                            if(mysql_num_rows($re)> 0){
                                while($rows = mysql_fetch_array($re)){
                                    echo'
                                    <form role="form" id="formnew" action="updateroom.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" class="form-control" name="room_id" id="room_id" placeholder="Room ID" value="' . $room_id . '" required>
                                        <div class="form-group">
                                            <label for="room_name">Room Name</label>
                                            <input type="text" class="form-control" name="room_name" id="room_name" placeholder="Room Name" value="' . $rows['room_name'] . '" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="total_room">Total Room</label>
                                            <input type="number" class="form-control" name="total_room" id="total_room" placeholder="Number of Room" value="' . $rows['total_room'] . '" required>
                                        </div>
                                        <div class="form-group">
