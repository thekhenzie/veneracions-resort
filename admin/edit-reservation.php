                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="starter.php" class="btn btn-primary">Back</a>
                        </div>
                            ...
                            <?php 
                                ...
                                if(mysql_num_rows($re)> 0){
                                    while($rows = mysql_fetch_array($re)){
                                        echo'
                                        <form role="form" id="formnew" action="updatereservation.php" method="post" enctype="multipart/form-data">
                                            <input type="hidden" class="form-control" name="booking_id" id="booking_id" placeholder="" value="' . $rows['booking_id'] . '" required>
                                            <div class="form-group">
                                                <label for="first_name">First Name</label>
                                                <input type="text" class="form-control" name="first_name" id="first_name" placeholder="First name" value="' . $rows['first_name'] . '" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="last_name">Last Name</label>
                                                <input type="text" class="form-control" name="last_name" id="last_name" placeholder="Last name" value="' . $rows['last_name'] . '" required>
                                            </div>
